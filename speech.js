...
module.exports = {
  main: function(settings, audioStream) {
    ...
    // fs.createReadStream('test.wav').on('data', function(arrayBuffer) {
    //   audioStream.write(arrayBuffer.slice());
    // }).on('end', function() {
    //   audioStream.close();
    // });

    // setTimeout(function() {fs.createReadStream('test.wav').on('data', function(arrayBuffer) {
